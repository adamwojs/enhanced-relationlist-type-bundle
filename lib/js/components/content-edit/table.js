...
TableElement.propTypes = {
    settings: PropTypes.shape({
        selectionAllowDuplicates: PropTypes.bool.required,
        groupSettings: PropTypes.bool.required,
        defaultBrowseLocation: PropTypes.number.required,
        selectionLimit: PropTypes.number.required,
        relationValidator: PropTypes.shape({
            allowedContentTypes: PropTypes.arrayOf(PropTypes.string).required,
        }).required,
    }).required,
    validation: PropTypes.object.required,
    languages: PropTypes.arrayOf(PropTypes.string).required,
    ...
    attributeModules: PropTypes.arrayOf(PropTypes.instanceOf(Component)).required,
    removeList: PropTypes.arrayOf(PropTypes.number).required,
    items: PropTypes.arrayOf(PropTypes.object).required,
    restInfo: PropTypes.shape({
        token: PropTypes.string.required,
        siteaccess: PropTypes.string.required,
    }).required,
    value: PropTypes.array.required,
    addGroupRow: PropTypes.func.required,
    updateGroupName: PropTypes.func.required,
    toggleRemove: PropTypes.func.required,
    updateRowAttribute: PropTypes.func.required,
    addRelationRows: PropTypes.func.required,
    removeRows: PropTypes.func.required,
};
