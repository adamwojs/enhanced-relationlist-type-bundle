...
GroupRowElement.propTypes = {
    ...
    remove: PropTypes.bool.required,
    isSystemGroup: PropTypes.bool.required,
    settings: PropTypes.shape({
        attributeDefinitions: PropTypes.object.required,
        groupSettings: PropTypes.shape({
            positionsFixed: PropTypes.bool.required,
        }).required,
    }).required,
};
